...
export default class SpinnerOverlay extends Component {
    render() {
        ...
        return <Flex className={classnames('tt-spiner-overlay',{'fixed': this.props.fixed, 'absolute': this.props.absolute})} style={style} alignItems="center" justifyContent="center">
